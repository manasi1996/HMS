...
#  Feb 10, 2020 11:35:26 AM IST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    wm geometry $top 732x450+272+137
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    place $site_4_0.but53 \
        -in $site_4_0 -x 420 -y 70 -anchor nw -bordermode ignore 
    ...
    place $site_3_0.fra50 \
        -in $site_3_0 -x 30 -y 30 -width 525 -relwidth 0 -height 115 \
        -relheight 0 -anchor nw -bordermode ignore 
    labelframe $top.lab54 \
        -font {-family {Segoe UI} -size 10 -weight bold} -foreground #3a3d87 \
        -text {Existing User} -background #ffff8a -height 195 \
    ...
    frame $site_3_0.fra55 \
        -borderwidth 2 -relief groove -background #b5ea4b -height 135 \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black \
        -width 525 
    ...
    place $site_4_0.rad46 \
        -in $site_4_0 -x 120 -y 90 -width 107 -relwidth 0 -height 31 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_0.rad47 \
        -in $site_4_0 -x 250 -y 90 -width 71 -relwidth 0 -height 31 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    place $site_3_0.fra55 \
        -in $site_3_0 -x 30 -y 30 -width 525 -relwidth 0 -height 135 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $site_3_0.but58 \
        -in $site_3_0 -x 490 -y 120 -width 51 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode ignore 
    ###################
    # SETTING GEOMETRY
    ###################
    ...
    place $top.lab49 \
        -in $top -x 60 -y 10 -width 580 -relwidth 0 -height 165 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.lab54 \
        -in $top -x 60 -y 220 -width 580 -relwidth 0 -height 195 -relheight 0 \
        -anchor nw -bordermode ignore 
